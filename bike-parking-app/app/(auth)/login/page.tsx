    ...
    <div className="w-full max-w-sm">
      <form className="bg-white shadow-md rounded px-8 py-6">
        ...
        <div className='flex justify-center my-4'>
          <div className='w-[130px] text-gray-400 flex items-center px-4'>
        ...
        <button className="flex w-full border-2 py-2 mb-5 rounded-md justify-center items-center font-semibold">
        ...
        <Link href="/Map" className="flex justify-center text-sm font-semibold text-gray-400 hover:cursor-pointer">Continue as Guest</Link>
      </form>
    </div>
  )
}
